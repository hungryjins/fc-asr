...
class LibriSpeechDataModule(LightningDataModule):
    ...
    def train_dataloader(self):
        datasets = [
            self.librispeech_cls(self.librispeech_path, url="train-clean-360", download=False),
            self.librispeech_cls(self.librispeech_path, url="train-clean-100", download=False),
            self.librispeech_cls(self.librispeech_path, url="train-other-500", download=False),
        ]
    ...
    def val_dataloader(self):
        datasets = [
            self.librispeech_cls(self.librispeech_path, url="dev-clean", download=False),
            self.librispeech_cls(self.librispeech_path, url="dev-other", download=False),
        ]
    ...
    def test_dataloader(self):
        dataset = self.librispeech_cls(self.librispeech_path, url="test-clean", download=False)
